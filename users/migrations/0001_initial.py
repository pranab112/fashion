...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('address_type', models.CharField(choices=[('H', 'Home'), ('W', 'Work'), ('O', 'Other')], default='H', max_length=1, verbose_name='Address type')),
                ...
                ('phone', models.CharField(default='', max_length=17, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')], verbose_name='Phone number')),
                ('street_address', models.CharField(default='', max_length=255, verbose_name='Street address')),
                ('apartment', models.CharField(blank=True, default='', max_length=100, verbose_name='Apartment, suite, etc.')),
